...
const (
	...
	// ConsensusTypeHoneyBadgerBFT is set for keepping away from the limitation of OrdererType
	ConsensusTypeHoneyBadgerBFT = "honeybadgerbft"
...
func New(conf *genesisconfig.Profile) Generator {
	...
	if conf.Orderer != nil {
		...
		case ConsensusTypeHoneyBadgerBFT:
		default:
