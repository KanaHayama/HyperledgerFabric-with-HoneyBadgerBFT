...
func (c *TopLevel) completeInitialization(configDir string) {
	...
	for {
		...
		case c.HoneyBadgerBFT.ThresholdEncryptionVerificationKeys == nil:
			//logger.Infof("HoneyBadgerBFT.ThresholdEncryptionVerificationKeys unset, setting to %v", defaults.HoneyBadgerBFT.ThresholdEncryptionVerificationKeys)
			logger.Panic("HoneyBadgerBFT.ThresholdEncryptionVerificationKeys unset")
		...
		case c.HoneyBadgerBFT.ThresholdSignatureVerificationKeys == nil:
			//logger.Infof("HoneyBadgerBFT.ThresholdSignatureVerificationKeys unset, setting to %v", defaults.HoneyBadgerBFT.ThresholdSignatureKeyVerificationKeys)
			logger.Panic("HoneyBadgerBFT.ThresholdSignatureVerificationKeys unset")
		case c.HoneyBadgerBFT.ThresholdSignaturePrivateKey == "":
			//logger.Infof("HoneyBadgerBFT.ThresholdSignaturePrivateKey unset, setting to %s", defaults.HoneyBadgerBFT.ThresholdSignatureKeyPrivateKey)
			logger.Panic("HoneyBadgerBFT.ThresholdSignaturePrivateKey unset")
